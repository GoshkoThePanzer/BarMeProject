...
public class Setup {
    public void setupBar(BarDB db) {
        db.add(new Bar("Кръкалника", 43.2060872, 23.5658356,
                LocalTime.of(0, 0), LocalTime.of(23, 59), 581, 380));
        db.add(new Bar("Рок клуб The Stage", 43.207122, 23.553563,
                LocalTime.of(21, 0), LocalTime.of(5, 0), 422, 377));
        db.add(new Bar("Тракийска принцеса", 43.204687, 23.552347,
                LocalTime.of(8, 30), LocalTime.of(23, 59), 389, 408));
        db.add(new Bar("Бижу", 43.205137, 23.556241,
                LocalTime.of(6, 0), LocalTime.of(2, 0), 450, 407));
        db.add(new Bar("Кадифе", 43.202918, 23.549158,
                LocalTime.of(7, 0), LocalTime.of(15, 0), 353, 440));
        db.add(new Bar("Валентино", 43.201610, 23.549212,
                LocalTime.of(7, 0), LocalTime.of(23, 0), 355, 469));
        db.add(new Bar("Кафе Ола", 43.204831, 23.553249,
                LocalTime.of(7, 0), LocalTime.of(23, 0), 410, 409));
        db.add(new Bar("Фламинго", 43.202805, 23.551010,
                LocalTime.of(7, 30), LocalTime.of(22, 30), 464, 498));
        db.add(new Bar("Метър бира", 43.224733, 23.552799,
                LocalTime.of(16, 0), LocalTime.of(23, 45), 402, 33));
        db.add(new Bar("Пинтата", 43.206256, 23.551295,
                LocalTime.of(11, 30), LocalTime.of(23, 0), 384, 382));
    }
